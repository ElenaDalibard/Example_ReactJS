...
export class ToDo extends Component {
    ...
    editLine = () => {
        if (!this.state.editForm) {
            ...
            this.props.editTodo(this.state.editTodo, this.props.text)
            this.setState({
                editForm: false,
                editTodo: "",
                editBtnText: "Modifier"
    ...
    render() {
        ...
        if (this.state.editForm) {
            ...
            }} className="col-9" defaultValue={this.props.text} />)
        }
        else {
            ligne.push(<div className="col-9" className={this.state.textColor}>{this.props.text}</div>)
        }
        return (
            <article className="container">
                <div className="row m-1 justify-content-between">
                    <div className="col-7">
                        <div onClick={this.setDone} className="row todoline justify-content-between">
                            {ligne}
